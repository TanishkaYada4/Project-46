...
deadzombieImg = loadAnimation("assets/z1.png","assets/z2.png","assets/z3.png","assets/z4.png","assets/z5.png","assets/z6.png")
  bgImg = loadImage("assets/bg.jpeg")
  bulletimg = loadImage("assets/bulletimg.png")
batImg=loadAnimation("assets/bat1.png","assets/bat2.png","assets/bat3.png")
explosion=loadAnimation("assets/e1.png","assets/e2.png","assets/e3.png")
}
...
if(zombieGroup.isTouching(bulletGroup)){
  for(var i=0;i<zombieGroup.length;i++){     
   ...
   if(bulletGroup.isTouching(zombieGroup)){
    var deadzombie=createSprite(zombieGroup[i].x,zombieGroup[i].y,50,50)
    deadzombie.addAnimation("deadZombie",explosion)
    deadzombie.scale=0.3
    deadzombie.life=10
    score +=5
//destroy zombie
...
function enemy(){
  if(frameCount%70===0){
    ...
    zombie.addAnimation("deadZombie",deadzombieImg)

    //zombie.addImage(zombieImg)
    zombie.scale = 0.3
    zombie.velocityX = -(3+2*score/5)
    zombie.debug= false
...
function bats(){
  ...
  if (frameCount%70===0){
    bat=createSprite(random(500,1100),random(0,100),40,40)
  bat.addAnimation("bats",batImg)
  bat.scale=0.3
  bat.velocityX=-3
  bat.lifetime=400
  batGroup.add(bat)
